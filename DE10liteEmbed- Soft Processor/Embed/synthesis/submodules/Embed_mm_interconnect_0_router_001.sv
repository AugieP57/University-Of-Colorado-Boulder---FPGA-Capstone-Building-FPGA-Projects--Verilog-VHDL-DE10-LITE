...
(
    ...
    localparam PAD4 = log2ceil(64'h8409230 - 64'h8409220); 
    localparam PAD5 = log2ceil(64'h8409240 - 64'h8409230); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h8409240;
    ...
    // ( 0x8409220 .. 0x8409230 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 28'h8409220   ) begin
            src_channel = 8'b100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x8409230 .. 0x8409240 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 28'h8409230   ) begin
