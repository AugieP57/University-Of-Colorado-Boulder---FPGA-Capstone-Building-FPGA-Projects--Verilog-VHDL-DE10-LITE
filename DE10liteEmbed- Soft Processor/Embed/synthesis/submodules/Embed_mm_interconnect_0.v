...
module Embed_mm_interconnect_0 (
	...
	wire  [107:0] onchip_flash_0_csr_agent_rf_source_data;                                            // onchip_flash_0_csr_agent:rf_source_data -> onchip_flash_0_csr_agent_rsp_fifo:in_data
	...
	wire  [107:0] onchip_flash_0_csr_agent_rsp_fifo_out_data;                                         // onchip_flash_0_csr_agent_rsp_fifo:out_data -> onchip_flash_0_csr_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> onchip_flash_0_csr_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // onchip_flash_0_csr_agent:cp_ready -> cmd_mux:src_ready
	wire    [7:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> onchip_flash_0_csr_agent:cp_channel
	...
	wire  [107:0] onchip_flash_0_data_agent_rf_source_data;                                           // onchip_flash_0_data_agent:rf_source_data -> onchip_flash_0_data_agent_rsp_fifo:in_data
	...
	wire  [107:0] onchip_flash_0_data_agent_rsp_fifo_out_data;                                        // onchip_flash_0_data_agent_rsp_fifo:out_data -> onchip_flash_0_data_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> onchip_flash_0_data_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // onchip_flash_0_data_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [7:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> onchip_flash_0_data_agent:cp_channel
	...
	wire  [106:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_ram_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // onchip_ram_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> onchip_ram_s1_agent:cp_channel
	...
	wire  [107:0] spi_0_spi_control_port_agent_rf_source_data;                                        // spi_0_spi_control_port_agent:rf_source_data -> spi_0_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [107:0] spi_0_spi_control_port_agent_rsp_fifo_out_data;                                     // spi_0_spi_control_port_agent_rsp_fifo:out_data -> spi_0_spi_control_port_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> spi_0_spi_control_port_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // spi_0_spi_control_port_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> spi_0_spi_control_port_agent:cp_channel
	...
	wire  [107:0] altpll_0_pll_slave_agent_rf_source_data;                                            // altpll_0_pll_slave_agent:rf_source_data -> altpll_0_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [107:0] altpll_0_pll_slave_agent_rsp_fifo_out_data;                                         // altpll_0_pll_slave_agent_rsp_fifo:out_data -> altpll_0_pll_slave_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> altpll_0_pll_slave_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // altpll_0_pll_slave_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> altpll_0_pll_slave_agent:cp_channel
	...
	wire   [27:0] altpll_1_pll_slave_agent_m0_address;                                                // altpll_1_pll_slave_agent:m0_address -> altpll_1_pll_slave_translator:uav_address
	...
	wire  [107:0] altpll_1_pll_slave_agent_rf_source_data;                                            // altpll_1_pll_slave_agent:rf_source_data -> altpll_1_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [107:0] altpll_1_pll_slave_agent_rsp_fifo_out_data;                                         // altpll_1_pll_slave_agent_rsp_fifo:out_data -> altpll_1_pll_slave_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> altpll_1_pll_slave_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // altpll_1_pll_slave_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> altpll_1_pll_slave_agent:cp_channel
	...
	wire  [106:0] onchip_flash_0_csr_agent_rp_data;                                                   // onchip_flash_0_csr_agent:rp_data -> router_002:sink_data
	...
	wire  [106:0] onchip_flash_0_data_agent_rp_data;                                                  // onchip_flash_0_data_agent:rp_data -> router_003:sink_data
	...
	wire  [106:0] onchip_ram_s1_agent_rp_data;                                                        // onchip_ram_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [106:0] spi_0_spi_control_port_agent_rp_data;                                               // spi_0_spi_control_port_agent:rp_data -> router_007:sink_data
	...
	wire  [106:0] altpll_0_pll_slave_agent_rp_data;                                                   // altpll_0_pll_slave_agent:rp_data -> router_008:sink_data
	...
	wire          altpll_1_pll_slave_agent_rp_valid;                                                  // altpll_1_pll_slave_agent:rp_valid -> router_009:sink_valid
	wire  [106:0] altpll_1_pll_slave_agent_rp_data;                                                   // altpll_1_pll_slave_agent:rp_data -> router_009:sink_data
	wire          altpll_1_pll_slave_agent_rp_ready;                                                  // router_009:sink_ready -> altpll_1_pll_slave_agent:rp_ready
	wire          altpll_1_pll_slave_agent_rp_startofpacket;                                          // altpll_1_pll_slave_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          altpll_1_pll_slave_agent_rp_endofpacket;                                            // altpll_1_pll_slave_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [106:0] sdram_s1_rsp_width_adapter_src_data;                                                // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	...
	wire  [106:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> sdram_s1_cmd_width_adapter:in_data
	...
	wire  [106:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> crosser:in_data
	wire          cmd_demux_001_src4_ready;                                                           // crosser:in_ready -> cmd_demux_001:src4_ready
	wire    [7:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> crosser:in_channel
	...
	wire  [106:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_007:sink0_data
	...
	wire  [106:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux_001:sink4_data
	wire          crosser_002_out_ready;                                                              // rsp_mux_001:sink4_ready -> crosser_002:out_ready
	wire    [7:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux_001:sink4_channel
	...
	wire  [106:0] rsp_demux_007_src0_data;                                                            // rsp_demux_007:src0_data -> crosser_003:in_data
	...
	Embed_mm_interconnect_0_router_003 router_004 (
	...
	Embed_mm_interconnect_0_router_003 router_005 (
	...
	Embed_mm_interconnect_0_router_006 router_006 (
	...
	Embed_mm_interconnect_0_router_002 router_007 (
	...
	Embed_mm_interconnect_0_router_008 router_008 (
	...
	Embed_mm_interconnect_0_router_008 router_009 (
	...
	Embed_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (altpll_0_c0_clk),                                               //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	Embed_mm_interconnect_0_rsp_demux_007 rsp_demux_007 (
		.clk                (clk_1_clk_clk),                                              //       clk.clk
		.reset              (altpll_1_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (altpll_0_c0_clk),                                //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
