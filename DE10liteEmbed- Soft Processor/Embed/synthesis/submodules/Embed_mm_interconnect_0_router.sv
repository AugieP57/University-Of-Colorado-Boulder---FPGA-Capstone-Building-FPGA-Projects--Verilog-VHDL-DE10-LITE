...
(
    ...
    localparam PAD4 = log2ceil(64'h8409220 - 64'h8409200); 
    localparam PAD5 = log2ceil(64'h8409250 - 64'h8409248); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h8409250;
    ...
    // ( 0x8409200 .. 0x8409220 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 28'h8409200   ) begin
            src_channel = 8'b100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x8409248 .. 0x8409250 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 28'h8409248   ) begin
