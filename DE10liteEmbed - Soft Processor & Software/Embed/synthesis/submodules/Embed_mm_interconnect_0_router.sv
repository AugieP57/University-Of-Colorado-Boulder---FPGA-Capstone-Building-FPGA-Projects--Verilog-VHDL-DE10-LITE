...
(
    ...
    localparam PAD1 = log2ceil(64'h1220 - 64'h1200); 
    localparam PAD2 = log2ceil(64'h1248 - 64'h1240); 
    localparam PAD3 = log2ceil(64'h100c000 - 64'h1008000); 
    localparam PAD4 = log2ceil(64'h1600000 - 64'h1400000); 
    ...
    // ( 0x1200 .. 0x1220 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 28'h1200   ) begin
            src_channel = 11'b100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x1240 .. 0x1248 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 28'h1240   ) begin
            src_channel = 11'b000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x1008000 .. 0x100c000 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 28'h1008000   ) begin
            src_channel = 11'b001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x1400000 .. 0x1600000 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 28'h1400000   ) begin
