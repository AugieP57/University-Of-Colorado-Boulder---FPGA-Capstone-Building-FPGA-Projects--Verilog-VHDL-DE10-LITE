...
(
    ...
    localparam PAD1 = log2ceil(64'h1200 - 64'h1000); 
    localparam PAD2 = log2ceil(64'h1230 - 64'h1220); 
    localparam PAD3 = log2ceil(64'h1240 - 64'h1230); 
    localparam PAD4 = log2ceil(64'h1250 - 64'h1248); 
    localparam PAD5 = log2ceil(64'h3000 - 64'h2000); 
    localparam PAD6 = log2ceil(64'h100c000 - 64'h1008000); 
    localparam PAD7 = log2ceil(64'h1600000 - 64'h1400000); 
    ...
    // ( 0x1220 .. 0x1230 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 28'h1220   ) begin
            src_channel = 11'b000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x1230 .. 0x1240 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 28'h1230   ) begin
            src_channel = 11'b000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x1248 .. 0x1250 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 28'h1248   ) begin
    ...
    // ( 0x1008000 .. 0x100c000 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 28'h1008000   ) begin
            src_channel = 11'b000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x1400000 .. 0x1600000 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 28'h1400000   ) begin
